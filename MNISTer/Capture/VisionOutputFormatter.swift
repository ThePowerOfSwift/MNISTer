...
//    func glyphImages(for observation: VNRectangleObservation, from pixelBuffer: CVPixelBuffer) -> UIImage {
...
//            context.cgContext.addRect(observation.boundingBox.applying(t))
